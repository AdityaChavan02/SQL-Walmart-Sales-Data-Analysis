...
2)The Project aims to understand and get an overview of the Consumer Payment Behaviour.
3)Finally the study aims to know how different strategies can be optimized during Holiday and Non-Holiday weeks at different stores for diffeent prodcuts to optimize the markdowns and increase sales.

DATASET DESCRIPTION:
The Dataset was obtained from https://github.com/Princekrampah/WalmartSalesAnalysis.git
The Dataset contains transactions from 3 differnet branches namely, Yangon, Naypyitaw and Mandalay
